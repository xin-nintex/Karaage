    ...
    public partial class AutoIncrement : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.AlterColumn<DateTime>(
                ...
                oldDefaultValue: new DateTime(2023, 2, 5, 8, 40, 41, 316, DateTimeKind.Utc).AddTicks(9017));
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.AlterColumn<DateTime>(
                ...
                type: "timestamp with time zone",
                nullable: false,
                defaultValue: new DateTime(2023, 2, 5, 8, 40, 41, 316, DateTimeKind.Utc).AddTicks(9017),
                oldClrType: typeof(DateTime),
                oldType: "timestamp with time zone",
